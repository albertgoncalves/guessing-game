...
def pt():
    ...
    for question, answer in [
        ...
        ("perdurar", "to endure, to linger, to persist"),
        ("esgotar", "to deplete, to exhaust"),
        ("magoar", "to hurt, to upset"),
        ("não faz mal", "no worries"),
        ("foi sem querer", "my bad"),
        ("o ensejo", "intention, occasion, opportunity"),
        ("figurar", "to appear, to represent"),
        ("a vizinhança", "neighbourhood, vicinity"),
        ("ríspido", "harsh"),
        ("soltar", "to drop, to loosen, to release"),
        ("arrastar", "to drag, to pull"),
        ("pressentir", "to feel, to sense"),
        ("insinuar", "to imply, to insinuate"),
        ("claro", "clear, light"),
        ("torto", "crooked, uneven"),
        ("esticar", "to stretch"),
        ("frouxo", "loose"),
        ("passear", "to stroll"),
        ("a parede", "wall"),
        ("parado", "stationary, still, stuck"),
        ("a parada", "break, pause, stop"),
        ("a desvantagem", "disadvantage"),
        ("despedir", "to dismiss, to lay off"),
        ("ocupado", "busy"),
        ("o problema", "problem"),
        ("o diagrama", "diagram"),
        ("a região", "region"),
        ...
        ("a inveja", "envy"),
        ("o enfermeiro", "nurse"),
        ("o feitio", "personality"),
        ("o canalha", "scoundrel"),
        ("o engano", "mistake"),
        ("o equívoco", "misconception"),
        ("a tolice", "nonsense"),
        ("a mesquinharia", "pettiness"),
        ("o fedor", "stench"),
        ("destrancar", "to unlock"),
        ("abafado", "muffled, stuffy"),
        ("o trago", "mouthful"),
        ("arejar", "to aerate"),
        ("desgastante", "grueling, tiring"),
        ("a faxina", "house-cleaning"),
        ("ansioso", "anxious, eager"),
        ("assoalhar", "to plank over"),
        ("intrometer", "to intrude"),
        ("viver", "to live"),
        ("o boato", "rumor"),
        ("propor", "to offer, to propose"),
        ("arremessar", "to hurl, to throw"),
        ("encabular", "to embarrass"),
        ("irritado", "angry"),
